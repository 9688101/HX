...
func GetAllUsers(c *gin.Context) {
	...
	users, err := entity.GetAllUsers(p*config.ItemsPerPage, config.ItemsPerPage, order)
...
func SearchUsers(c *gin.Context) {
	...
	users, err := entity.SearchUsers(keyword)
	if err != nil {
		c.JSON(http.StatusOK, gin.H{
			"success": false,
			"message": err.Error(),
...
func GetUser(c *gin.Context) {
	...
	user, err := entity.GetUserById(id, false)
	if err != nil {
		c.JSON(http.StatusOK, gin.H{
			"success": false,
			"message": err.Error(),
...
func GenerateAccessToken(c *gin.Context) {
	id := c.GetInt(ctxkey.Id)
	user, err := entity.GetUserById(id, true)
	if err != nil {
		c.JSON(http.StatusOK, gin.H{
			"success": false,
			"message": err.Error(),
	...
	if entity.DB.Where("access_token = ?", user.AccessToken).First(user).RowsAffected != 0 {
		c.JSON(http.StatusOK, gin.H{
			"success": false,
...
func UpdateUser(c *gin.Context) {
	...
	originUser, err := entity.GetUserById(updatedUser.Id, false)
	if err != nil {
		c.JSON(http.StatusOK, gin.H{
			"success": false,
			"message": err.Error(),
	...
	if myRole <= updatedUser.Role && myRole != entity.RoleRootUser {
		c.JSON(http.StatusOK, gin.H{
			"success": false,
	...
	if originUser.Quota != updatedUser.Quota {
		entity.RecordLog(ctx, originUser.Id, entity.LogTypeManage, fmt.Sprintf("管理员将用户额度从 %s修改为 %s", common.LogQuota(originUser.Quota), common.LogQuota(updatedUser.Quota)))
	}
	c.JSON(http.StatusOK, gin.H{
		"success": true,
		"message": "",
...
func DeleteUser(c *gin.Context) {
	...
	originUser, err := entity.GetUserById(id, false)
	if err != nil {
		c.JSON(http.StatusOK, gin.H{
			"success": false,
			"message": err.Error(),
...
func DeleteSelf(c *gin.Context) {
	id := c.GetInt("id")
	user, _ := entity.GetUserById(id, false)
...
func ManageUser(c *gin.Context) {
	...
	// Fill attributes
	entity.DB.Where(&user).First(&user)
	if user.Id == 0 {
		c.JSON(http.StatusOK, gin.H{
			"success": false,
			"message": "用户不存在",
...
func TopUp(c *gin.Context) {
	...
	id := c.GetInt("id")
	quota, err := entity.Redeem(ctx, req.Key, id)
	if err != nil {
		c.JSON(http.StatusOK, gin.H{
			"success": false,
			"message": err.Error(),
...
func AdminTopUp(c *gin.Context) {
	...
	err = entity.IncreaseUserQuota(req.UserId, int64(req.Quota))
	if err != nil {
		c.JSON(http.StatusOK, gin.H{
			"success": false,
			"message": err.Error(),
	...
	entity.RecordTopupLog(ctx, req.UserId, req.Remark, req.Quota)
	c.JSON(http.StatusOK, gin.H{
		"success": true,
		"message": "",
	})
