...
import (
	...
	relay "github.com/9688101/HX/relay"
...
func ListModels(c *gin.Context) {
	...
	if c.GetString(ctxkey.AvailableModels) != "" {
		...
		userGroup, _ := entity.CacheGetUserGroup(userId)
		availableModels, _ = entity.CacheGetGroupModels(ctx, userGroup)
	}
...
func GetUserAvailableModels(c *gin.Context) {
	...
	userGroup, err := entity.CacheGetUserGroup(id)
	if err != nil {
		c.JSON(http.StatusOK, gin.H{
			"success": false,
			"message": err.Error(),
	...
	models, err := entity.CacheGetGroupModels(ctx, userGroup)
	if err != nil {
		c.JSON(http.StatusOK, gin.H{
			"success": false,
			"message": err.Error(),
